                        ...
                        <div className="space-y-4">
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="bg-white rounded-xl border border-gray-100 p-3.5 space-y-3 shadow-sm">
                              ...
                              <div className="flex items-start gap-2.5 border-t border-gray-50 pt-3">
                                <div className="w-7 h-7 rounded-lg bg-amber-50 flex items-center justify-center text-amber-500 shrink-0">
                                  <Building2 size={12} />
                                </div>
                                <div className="flex-1">
                                  <span className="text-[7px] font-bold text-gray-400 uppercase block mb-0.5">Bank Info</span>
                                  <div className="space-y-1">
                                    <div className="flex justify-between items-center">
                                      <span className="text-[8px] font-medium text-gray-500">A/C:</span>
                                      <button onClick={() => handleCopy("987654321012", "Account Number")} className="flex items-center gap-1">
                                        <span className="text-[8px] font-bold text-gray-900">987654321012</span>
                                        <Copy size={8} className="text-gray-300" />
                                      </button>
                                    </div>
                                    <div className="flex justify-between items-center">
                                      <span className="text-[8px] font-medium text-gray-500">IFSC:</span>
                                      <button onClick={() => handleCopy("FLEX0001234", "IFSC Code")} className="flex items-center gap-1">
                                        <span className="text-[8px] font-bold text-gray-900">FLEX0001234</span>
                                        <Copy size={8} className="text-gray-300" />
                                      </button>
                                    </div>
                                  </div>
