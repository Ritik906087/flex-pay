...
import { 
  Loader2, Copy, Clock, QrCode, 
  AlertCircle, ChevronLeft, XCircle, ShieldCheck
} from "lucide-react";
...
export default function UsdtClient() {
          ...
          <div className="space-y-6">
            <div className="flex flex-col gap-2">
              ...
              <Input 
                ...
                className="h-14 bg-gray-50 border-gray-100 rounded-xl font-black text-[11px] tracking-wider focus:bg-white transition-all"
                value={txid}
            ...
            <div className="flex gap-3 pt-6">
              <Button variant="outline" className="flex-1 h-14 rounded-xl font-bold uppercase tracking-wider text-[9px]" onClick={() => setStep(1)}>Back</Button>
              <Button 
